...
public class AddLight implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if(sender instanceof Player){
            ...
            if(label.equalsIgnoreCase("addlight")){

                if(player.hasPermission("deceit.admin")){

                    File file = Deceit.getFiles().getLightFile();
                    ...
                    player.sendMessage("§7Light set en§f: §b" + location.getX() + " " + location.getY() + " " + location.getZ() + "§7.");
